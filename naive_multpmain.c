/*
** naive_multpmain.c for Bistromathique in /home/schmou_a/Bistromathique sans warnings
** 
** Made by adrien schmouker
** Login   <schmou_a@epitech.net>
** 
** Started on  Sun Nov  9 20:34:55 2014 adrien schmouker
** Last update Sun Nov  9 20:34:56 2014 adrien schmouker
*/
...
int	main(int argc, char **argv)
{
  ...
  my_disp_test(naive_multp(nb1, nb2, 10));
  my_putchar('\n');
  return (0);
}
