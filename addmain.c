/*
** addmain.c for Bistromathique in /home/schmou_a/Bistromathique sans warnings
** 
** Made by adrien schmouker
** Login   <schmou_a@epitech.net>
** 
** Started on  Sun Nov  9 20:23:37 2014 adrien schmouker
** Last update Sun Nov  9 20:23:38 2014 adrien schmouker
*/
...
int	main(int argc, char **argv)
{
  ...
  if (nb2 == NULL)
    return (0);
  my_disp_test(testadd(nb1, nb2, 10));
  my_putchar('\n');
  return (0);
}
