/*
** naive_modmain.c for Bistromathique in /home/schmou_a/Bistromathique sans warnings
** 
** Made by adrien schmouker
** Login   <schmou_a@epitech.net>
** 
** Started on  Sun Nov  9 20:34:22 2014 adrien schmouker
** Last update Sun Nov  9 20:34:23 2014 adrien schmouker
*/
...
int     main(int argc, char **argv)
{
  ...
  if ((res = naive_mod(nb1, nb2, 10)) == NULL)
    return (0);
  else
    {
      my_disp_test(res);
